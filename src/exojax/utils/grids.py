...
def extended_wavenumber_grid(nu_grid, nleft, nright):
    """generates an extended wavenumber grid by adding nleft and nright points to the left and right of the nu_grid.

    Args:
        nu_grid (array): wavenumber grid generated by grids.wavenumber_grid
        nleft (int): the number of points to be added to the left of nu_grid
        nright (int): the number of points to be added to the right of nu_grid

    Raises:
        ValueError: nu_grid should be evenly spaced in log space (ESLOG)

    Returns:
        array: extended wavenumber grid
    """
