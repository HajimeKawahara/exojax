...
#mask=(23193.5<wavd[::-1])*(wavd[::-1]<23310.0)
mask=(23341.6<wavd[::-1])*(wavd[::-1]<23453.2)
...
#nus,wav,res=nugrid(23183,23320,N,unit="AA")
nus,wav,res=nugrid(23330,23460,N,unit="AA")
...
#    norm=0.2
    ...
    plt.legend()
    plt.savefig("fig/spec_test4.png")
