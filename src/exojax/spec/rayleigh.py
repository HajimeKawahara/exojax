...
def cross_section_rayleigh_gas(wavenumber,
    ...
    """
    fac = (refractive_index**2 - 1.0) / (n_ref_refractive*(refractive_index**2 + 2.0))
    print(fac)
...
if __name__ == "__main__":
    ...
    nus,wav,res = wavenumber_grid(3000.0, 3100.0, 128, xsmode="premodit", wavelength_order="descending", unit='nm')
    sigma = cross_section_rayleigh_gas(nus,refractive_index)
    print(sigma)