...
from exojax.test.data import TESTDATA_CO_HITEMP_PREMODIT_REFLECTION_REF
...
testdata_reflection_premodit["hitemp"] = TESTDATA_CO_HITEMP_PREMODIT_REFLECTION_REF
...
def generate_testdata_reflection_premodit(db):
    ...
    np.savetxt(
        testdata_reflection_premodit[db], np.array([nu_grid, F0]).T, delimiter=","
    )
