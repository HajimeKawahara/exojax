...
mask=(22876.0<wavd[::-1])*(wavd[::-1]<23010.0)  #first order
#mask=(23038.6<wavd[::-1])*(wavd[::-1]<23159.3) #second order
...
wav=np.logspace(np.log10(23030),np.log10(23180),N,dtype=np.float64)#AA
nus=1.e8/wav[::-1]
