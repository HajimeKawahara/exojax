""" This code compares Premodit line strengths with those of MODIT.
...
opa = OpaPremodit(mdb=mdb, nu_grid=nus)
...
#Slsd_premodit = unbiased_lsd_zeroth(lbd_zeroth, T, opa.Tref, nus, elower_grid, qt)
Slsd_premodit = unbiased_lsd_first(lbd_zeroth, lbd_first, T, opa.Tref, opa.Twt, \
