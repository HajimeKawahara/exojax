...
if __name__=="__main__":
    import matplotlib
    m,std,R,ijd,iju,wls_modit,xs_modit_lp,xsv_lpf_lp,dif=comperr(100000)
...
#        plt.xlim(llow*10.0-tip,lhigh*10.0+tip)
        ...
        plt.plot(wls_modit,np.abs((dif)),alpha=0.2,color="C1",label="R="+str(R))
        plt.plot(wls_modit1,np.abs((dif1)),alpha=0.5,color="C2",label="R="+str(R1))
