...
def test_convolve_rigid_rotation_trans(N=1000):
    nus, wav, resolution = wavenumber_grid(4000.0,
                                               4010.0,
                                               N,
                                               xsmode="premodit")
...
def test_convolve_rigid_rotation_trans_ola(N=10000):
    nus, wav, resolution = wavenumber_grid(4000.0,
                                               4010.0,
                                               N,
                                               xsmode="premodit")
...
def test_SopRotation_trans_ola(N=10000):
    from exojax.postproc.specop import SopRotation
    nus, wav, resolution = wavenumber_grid(4000.0,
                                               4010.0,
                                               N,
...
def test_integrated_rotkernel_trans():
...
def test_apply_weighted_rv_shifts(N=1000):
