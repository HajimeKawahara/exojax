...
import time
from exojax.spec import defmol, defcia, moldb, contdb, planck, molinfo, lpf, dit, modit, set_ditgrid, initspec, response
...
class AutoXS(object):
    ...
    def xsection(self, T, P):
        ...
        if xsmode == 'lpf' or xsmode == 'LPF':
            ...
            ngammaL_grid = ditgrid_log_interval(ngammaL, res=0.1)
            ...
            sigmaD_grid = ditgrid_log_interval(sigmaD, res=0.1)
            gammaL_grid = ditgrid_log_interval(gammaL, res=0.1)
