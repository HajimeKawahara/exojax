...
def test_sampling_band_integral():
    nus, wav, resolution = wavenumber_grid(4000.0,
                                               4010.0,
                                               1000,
                                               xsmode="premodit")
...
def test_ipgauss_variable_sampling_using_constant_beta_array():
    nus, wav, resolution = wavenumber_grid(4000.0,
                                               4010.0,
                                               1000,
                                               xsmode="premodit")
