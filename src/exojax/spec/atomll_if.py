...
def gamma_vald3(T, PH, PHH, PHe, ielem, iion, \
    ...
    Args(inputs):
      ...
      vdW_meth: method to calculate gamma
            ...
            "V": van der Waals damping constant gamma at 10000 K for lines with the value in the line list (VALD or Kurucz), otherwise Unsoeld (1955)
    ...
    #CASE2 (van der Waals broadening based on gamma6 at 10000 K)
        else: #"V"
