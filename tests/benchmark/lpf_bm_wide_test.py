...
def test_benchmark_e(benchmark):
    ret = benchmark(xs,50000)
    assert ret

#def test_benchmark_f(benchmark):
#    ret = benchmark(xsm,50000,[[0,10000],[10000,20000],[20000,30000],[30000,40000],[40000,50000]])
#    assert ret

#if __name__ == "__main__":
#    xsm(10000,[[0,5000],[5000,10000]])
#    xsm(50000,[[0,10000],[10000,20000],[20000,30000],[30000,40000],[40000,50000]])
