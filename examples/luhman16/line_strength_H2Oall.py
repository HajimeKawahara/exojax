...
import numpy as np
N=1500
nus,wav,res=nugrid(22910,22960,N,unit="AA")
...
c=plt.scatter(1.e8/mdbM.nu_lines,hcperk*mdbM.elower,c=logSijTx,cmap="pink_r")
plt.yscale("log")
fs=16
lA=22913.298869521463
lB=22918.068522901758
lC=22955.672043593007
plt.text(lA,1300.0,"A",fontsize=fs,ha="center",color="C0")
plt.plot([lA,lA],[1500.0,2500.0],lw=1,color="C0")

plt.text(lB,3500,"B",fontsize=fs,ha="center",color="C1")
plt.plot([lB,lB],[4000.0,6000.0],lw=1,color="C1")
plt.xlim(22910,22960)
plt.text(lC,1050.0,"C",fontsize=fs,ha="center",color="C2")
plt.plot([lC,lC],[1200.0,1900.0],lw=1,color="C2")
...
plt.axvspan(1300.0,1350.0,alpha=0.3)
plt.tick_params(labelsize=18)
