...
def comparison_moldb_exomol():
    crit=1.e-30
    mapi = MdbExomol_api(".database/CO/12C-16O/Li2015",nurange=[4200.0,4300.0],crit=crit)
    morig = MdbExomol_orig(".database/CO/12C-16O/Li2015",nurange=[4200.0,4300.0],crit=crit)
