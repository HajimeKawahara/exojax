...
def test_basic_convolution_calc_open_xsection_from_lsd_zeroscan(i, figure=False):
    ...
    if i == -1:
        ...
        res_alias = np.max(np.abs(xsv[0:filter_length_oneside]/xsv_ref[0:filter_length_oneside]-1.0))
    else:
        raise ValueError("Invalid i")
    #print(res_alias)
    ...
    if figure:
        ...
        if i==0:
            ...
            plt.plot(xsv[-filter_length_oneside-1:]/xsv_ref[0:filter_length_oneside+1]-1,"o")
        plt.show()
