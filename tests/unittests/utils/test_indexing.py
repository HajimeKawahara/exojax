...
@pytest.mark.parametrize("indexer,array", [(getix, jnp.array), (npgetix, np.array)])
def test_getix_ascending(indexer, array):
    weights, indices = indexer(array([0.7, 1.3]), array([0.0, 1.0, 2.0]))
