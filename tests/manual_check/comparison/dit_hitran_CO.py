...
plt.plot(wls_dit, xsv_lpf_lp, label='Direct',
         color='C0', markersize=3, alpha=0.99)
...
plt.plot(wls_dit, np.abs(xs_dit_lp/xsv_lpf_lp-1.)*100,
         lw=1, alpha=0.5, color='C1', label='MODIT (F32)')
plt.plot(wls_dit, np.abs(xs_dit_lp_f64/xsv_lpf_lp-1.)*100,
         lw=1, alpha=1, color='C2', label='MODIT (F64)')
plt.yscale('log')
