...
These figures were generated by the commands above at the default state:

.. figure:: alkali_models/na.png
   :alt: Na-H2 resonance doublet, wings, and ratios for three matched profiles.

   Na--H2 at 1000 K and 1e19 cm-3. Grey bands show the numerical core/wing joins.

.. figure:: alkali_models/k.png
   :alt: K-He resonance doublet, wings, and ratios for three matched profiles.

   K--He at the same temperature and perturber density. Gaps in the far wings
   reflect nonpositive expansion results and finite table support, as discussed below.
