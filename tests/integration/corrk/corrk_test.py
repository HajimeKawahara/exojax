...
# segments
    ...
    return k_g,g,edges,cut_idx,nus_segments,xsv_segments,j,k_med,mask,y_base,y_base_,y_top
...
P = 1.0e-1
xsv = opa.xsvector(T, P)
k_g, g, edges, cut_idx, nus_segments, xsv_segments, j, k_med, mask, y_base, y_base_, y_top = computeg(nus, xsv)
plotxsv_1(nus, xsv, nus_segments, xsv_segments, j, k_med, mask, y_base, "T=700 K, P=0.1 bar", ax)
...
xsv = opa.xsvector(T, P)
k_g, g, edges, cut_idx, nus_segments, xsv_segments, j, k_med, mask, y_base, y_base_, y_top = computeg(nus, xsv)
plotxsv_1(nus, xsv, nus_segments, xsv_segments, j, k_med, mask, y_base, "T=1000 K, P=0.1 bar", ax)
ax.xaxis.set_ticklabels([])
ax.axes.get_xaxis().set_ticks([])
...
xsv = opa.xsvector(T, P)
k_g, g, edges, cut_idx, nus_segments, xsv_segments, j, k_med, mask, y_base, y_base_, y_top = computeg(nus, xsv)
plotxsv_1(nus, xsv, nus_segments, xsv_segments, j, k_med, mask, y_base, "T=1300 K, P=0.1 bar", ax)
ax.set_xlabel("$\\nu$ (cm-1)")
...
xsv = opa.xsvector(T, P)
k_g, g, edges, cut_idx, nus_segments, xsv_segments, j, k_med, mask, y_base, y_base_, y_top = computeg(nus, xsv)
plotxsv_1(nus, xsv, nus_segments, xsv_segments, j, k_med, mask, y_base, "T=1000 K, P=0.01 bar", ax)
ax.xaxis.set_ticklabels([])
ax.axes.get_xaxis().set_ticks([])
...
xsv = opa.xsvector(T, P)
k_g, g, edges, cut_idx, nus_segments, xsv_segments, j, k_med, mask, y_base, y_base_, y_top = computeg(nus, xsv)
plotxsv_1(nus, xsv, nus_segments, xsv_segments, j, k_med, mask, y_base, "T=1000 K, P=1 bar", ax)
ax.set_xlabel("$\\nu$ (cm-1)")
