...
nus=np.linspace(3000,6000.0,3000000,dtype=np.float64)
...
cnu,indexnu,dLarray=initspec.init_dit(mdbCO.nu_lines,nus,Nfold=2)
...
plt.plot(wls_dit,(xs_dit_lp/xsv_lpf_lp-1.)*100,alpha=0.3,color="C1")
